...
public:
     ...
     */
    void make_variable(std::vector<std::shared_ptr<csp::csp_variable>> &variables, std::size_t num);
     ...
     * @param var2
     */
    void constraint_difference(std::vector<std::shared_ptr<csp::csp_variable>> &variables,
     ...
     * @param sum
     */
    void constraint_sum(std::vector<std::shared_ptr<csp::csp_variable>> &variables,
